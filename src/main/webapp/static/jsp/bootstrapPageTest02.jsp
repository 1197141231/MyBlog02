...
<body>
<%
    int total=(Integer) request.getAttribute("page");

   // int total =100;
    int pageLimit = 10 ;
    int totalPages = (int) Math.ceil(total/pageLimit);
    int totalElements = total;
    int currentPage = 1;
...
<nav>
    <ul class="pagination">
        ...
        <c:set var="totalElements"  value="<%=totalElements%>"/>
